...
def train():
    ...
    # split = int(len(mnist.train.images)*0.8)
    # train_images = mnist.train.images[:split]
    # train_labels = mnist.train.labels[:split]
    # val_images = mnist.train.images[split:]
    # val_labels = mnist.train.labels[split:]
    def feed_dict(train):
